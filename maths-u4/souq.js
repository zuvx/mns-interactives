/* ============================================================
   The Number Souq — shared behaviour
   Rules: design-system/mns-classroom/pages/number-souq.md
   ...
   See CLAUDE.md and design-system/mns-classroom/pages/number-souq.md.
   ============================================================ */
(function () {
  'use strict';
  ...
  var SPRITE = [
    ...
    // lantern / souq mark
    '<symbol id="i-lantern" viewBox="0 0 24 24"><path d="M12 2v2M9 4h6M7 8a5 5 0 0 1 10 0v6a5 5 0 0 1-10 0V8Z"/><path d="M12 20v2M9 20h6"/></symbol>',
    // balance scale
    ...
    // purse
    '<symbol id="i-purse" viewBox="0 0 24 24"><path d="M4 8h16l1 12H3L4 8Z"/><path d="M8 8V6a4 4 0 0 1 8 0v2"/><circle cx="12" cy="14" r="1.5"/></symbol>',
    // exchange desk
  ...
  function injectSprite() {
    if (document.getElementById('souq-sprite')) return;
  ...
  /* ---------- Trader's Purse: points to show the teacher ----------
     ...
     nothing transmitted. See design-system/.../pages/number-souq.md. */
  var POINTS_SOLVED = 10;
  var POINTS_FIRST_TRY = 5;

  var lessonId = (document.body.getAttribute('data-lesson') || 'souq');
  var storeKey = 'souq-purse-' + lessonId;
  ...
  function buildToolbar() {
    ...
    // Purse badge, always visible so the child watches it grow.
    ...
    if (sumEl) {
      ...
      resetBtn.setAttribute('aria-label', 'Clear the purse for a new pupil');
      resetBtn.addEventListener('click', function () {
        if (window.confirm('Clear the purse and start again for a new pupil?')) {
          log.length = 0;
          resetPurse();
  ...
  function renderMyWork() {
    ...
    if (!purse.solved) {
      host.innerHTML =
        '<h3>My Trader’s Purse</h3>' +
        '<div class="big">0</div>' +
        '<div>points so far. Answer some questions to fill your purse.</div>';
      return;
    }
